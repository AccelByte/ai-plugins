...
# AGS Unreal SDK Installer

Install the AGS Unreal plugin set into an Unreal Engine project and verify that the project can authenticate against AGS.
...
Next step: /ags connect-portal, then rerun /ags install-unreal-sdk to configure and verify login
```
