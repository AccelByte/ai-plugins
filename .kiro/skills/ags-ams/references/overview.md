...
- https://docs.accelbyte.io/gaming-services/modules/multiplayer/multiplayer-servers/fleets/
- https://docs.accelbyte.io/gaming-services/modules/multiplayer/multiplayer-servers/ams-cli/
see-also:
...
| **Buffer Servers** | "Ready" reserve. Formula: `demand change per minute × max DS startup duration (1–10 min)`. Typical: 10–20% of peak claimed DS count |
...
- If not → AMS starts one on demand (first request **always fails**; AGS Session retries after 60 seconds)
